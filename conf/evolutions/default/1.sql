# --- !Ups
# PostgreSQL Optimized Schema for Sentiment Analysis NLP
...
-- Drop indexes
DROP INDEX IF EXISTS idx_reviews_keywords;
DROP INDEX IF EXISTS idx_analyses_sentiment_counts;
DROP INDEX IF EXISTS idx_products_metadata;
DROP INDEX IF EXISTS idx_reviews_text_search;
DROP INDEX IF EXISTS idx_comparison_analyses_comparison_id;
DROP INDEX IF EXISTS idx_reviews_analysis_id;
DROP INDEX IF EXISTS idx_reviews_sentiment_score;
DROP INDEX IF EXISTS idx_analyses_created_at;
DROP INDEX IF EXISTS idx_analyses_product_sentiment;
